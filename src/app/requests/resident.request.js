...
export const createItem = Joi.object({
    ...
    id_card_front_image: Joi.string().trim().optional().allow('').label('Ảnh mặt trước CCCD'),
    id_card_back_image: Joi.string().trim().optional().allow('').label('Ảnh mặt sau CCCD'),
    ...
    resident_type: Joi.string().valid('owner', 'tenant').optional().label('Loại cư dân'),
